...
// Recipients
$fromEmail = 'info@3dingeniousstudio.com'; // Email address that will be in the from field of the message.
$fromName = '3D Ingenious Studio'; // Name that will be in the from field of the message.
$sendToEmail = 'vinay9898@gmail.com'; // Email address that will receive the message with the output of the form
$sendToName = 'Vinay'; // Name that will receive the message with the output of the form

// Subject
$subject = 'Message from 3D Ingenious Studio contact form';
